...
VALUES
    ...
    (
        'NSGI',
        'Saba_DPnet_GEOGRAPHIC_3D_USAGE',
        'geodetic_crs',
        'NSGI',
        'Saba_DPnet_GEOGRAPHIC_3D',
        'EPSG',
    ...
    (
        'NSGI',
        'Saba_DPnet_GEOGRAPHIC_2D_USAGE',
        'geodetic_crs',
        'NSGI',
        'Saba_DPnet_GEOGRAPHIC_2D',
        'EPSG',
    ...
    (
        'NSGI',
        'St_Eustatius_DPnet_GEOCENTRIC_USAGE',
        'geodetic_crs',
        'NSGI',
        'St_Eustatius_DPnet_GEOCENTRIC',
        'EPSG',
    ...
    (
        'NSGI',
        'St_Eustatius_DPnet_GEOGRAPHIC_3D_USAGE',
        'geodetic_crs',
        'NSGI',
        'St_Eustatius_DPnet_GEOGRAPHIC_3D',
        'EPSG',
    ...
    (
        'NSGI',
        'St_Eustatius_DPnet_GEOGRAPHIC_2D_USAGE',
        'geodetic_crs',
        'NSGI',
        'St_Eustatius_DPnet_GEOGRAPHIC_2D',
        'EPSG',
