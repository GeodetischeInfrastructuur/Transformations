...
VALUES
    ...
    (
        'NSGI',
        'St_Eustatius_Local_GEOGRAPHIC_2D',
        'DPnet St_Eustatius',
        NULL,
        'geographic 2D',
        'EPSG',
...
VALUES
    ...
    (
        'NSGI',
        'Bonaire_DPnet_GEOCENTRIC_USAGE',
        'geodetic_crs',
        'NSGI',
        'Bonaire_DPnet_GEOCENTRIC',
        'EPSG',
    ...
    (
        'NSGI',
        'Bonaire_DPnet_GEOGRAPHIC_3D_USAGE',
        'geodetic_crs',
        'NSGI',
        'Bonaire_DPnet_GEOGRAPHIC_3D',
        'EPSG',
    ...
    (
        'NSGI',
        'Bonaire_DPnet_GEOGRAPHIC_2D_USAGE',
        'geodetic_crs',
        'NSGI',
        'Bonaire_DPnet_GEOGRAPHIC_2D',
        'EPSG',
    ...
    (
        'NSGI',
        'Saba_Local_GEOGRAPHIC_3D_USAGE',
        'geodetic_crs',
        'NSGI',
        'Saba_Local_GEOGRAPHIC_3D',
        'EPSG',
    ...
    (
        'NSGI',
        'Saba_Local_GEOGRAPHIC_2D_USAGE',
        'geodetic_crs',
        'NSGI',
        'Saba_Local_GEOGRAPHIC_2D',
        'EPSG',
    ...
    (
        'NSGI',
        'St_Eustatius_Local_GEOCENTRIC_USAGE',
        'geodetic_crs',
        'NSGI',
        'St_Eustatius_Local_GEOCENTRIC',
        'EPSG',
    ...
    (
        'NSGI',
        'St_Eustatius_Local_GEOGRAPHIC_3D_USAGE',
        'geodetic_crs',
        'NSGI',
        'St_Eustatius_Local_GEOGRAPHIC_3D',
        'EPSG',
    ...
    (
        'NSGI',
        'St_Eustatius_Local_GEOGRAPHIC_2D_USAGE',
        'geodetic_crs',
        'NSGI',
        'St_Eustatius_Local_GEOGRAPHIC_2D',
        'EPSG',
