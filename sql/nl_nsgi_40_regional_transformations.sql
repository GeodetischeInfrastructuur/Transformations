...
VALUES
    (
        'NSGI',
        'DPnet_Bonaire_TO_ITRF2000_2D',
        'DPnet Bonaire to ITRF2000 2D transformation',
        'transformation between DPnet Bonaire and ITRF2000',
        'PROJ',
        'PROJString',
...
VALUES
    (
        'NSGI',
        'DPnet_Bonaire_TO_ITRF2000_2D_USAGE',
        'other_transformation',
        'NSGI',
        'DPnet_Bonaire_TO_ITRF2000_2D',
        'EPSG',
...
VALUES
    (
        'NSGI',
        'DPnet_KADpeil_Bonaire_TO_ITRF2000_3D',
        'DPnet Bonaire to ITRF2000 3D transformation',
        'transformation between DPnet and KADpeil Bonaire and ITRF2000',
        'PROJ',
        'PROJString',
...
VALUES
    (
        'NSGI',
        'DPnet_KADpeil_Bonaire_TO_ITRF2000_3D_USAGE',
        'other_transformation',
        'NSGI',
        'DPnet_KADpeil_Bonaire_TO_ITRF2000_3D',
        'EPSG',
...
VALUES
    (
        'NSGI',
        'DPnet_St_Eustatius_TO_St_Eustatius2020',
...
VALUES
    (
        'NSGI',
        'DPnet_St_Eustatius_TO_St_Eustatius2020_USAGE',
        'other_transformation',
        'NSGI',
        'DPnet_St_Eustatius_TO_St_Eustatius2020',
        'EPSG',
