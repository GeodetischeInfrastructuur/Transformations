...
-------------------------------------------------------
--     Transformation: WGS 84 -> NSGI Dpnet NULL
-------------------------------------------------------
INSERT INTO
    "helmert_transformation" (
        auth_name,
...
VALUES
    (
        'NSGI',
        'NSGI_Bonaire2004_TO_WGS_84_NULL',
        'NSGI Bonaire DPnet TO WGS 84 null transformation',
        '',
        'EPSG',
        '9603',
        'Geocentric translations (geog2D domain)',
...
VALUES
    (
        'NSGI',
        'NSGI_Bonaire2004_TO_WGS_84_NULL_USAGE',
        'helmert_transformation',
        'NSGI',
        'NSGI_Bonaire2004_TO_WGS_84_NULL',
        'EPSG',
...
VALUES
    (
        'NSGI',
        'NSGI_Saba2020_TO_WGS_84_NULL',
        'NSGI Saba DPnet TO WGS 84 null transformation',
        '',
        'EPSG',
        '9603',
        'Geocentric translations (geog2D domain)',
...
VALUES
    (
        'NSGI',
        'NSGI_Saba2020_TO_WGS_84_NULL_USAGE',
        'helmert_transformation',
        'NSGI',
        'NSGI_Saba2020_TO_WGS_84_NULL',
        'EPSG',
...
VALUES
    (
        'NSGI',
        'NSGI_St_Eustatius2020_TO_WGS_84_NULL',
        'NSGI St_Eustatius DPnet TO WGS 84 null transformation',
        '',
        'EPSG',
        '9603',
        'Geocentric translations (geog2D domain)',
...
VALUES
    (
        'NSGI',
        'NSGI_St_Eustatius2020_TO_WGS_84_NULL_USAGE',
        'helmert_transformation',
        'NSGI',
        'NSGI_St_Eustatius2020_TO_WGS_84_NULL',
        'EPSG',
