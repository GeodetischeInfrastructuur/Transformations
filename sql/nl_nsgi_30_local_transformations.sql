...
-------------------------------------------------------
INSERT INTO
    "grid_transformation" ( auth_name, code, name, description, method_auth_name, method_code, method_name, source_crs_auth_name, source_crs_code, target_crs_auth_name, target_crs_code, accuracy, grid_param_auth_name, grid_param_code, grid_param_name, grid_name, grid2_param_auth_name, grid2_param_code, grid2_param_name, grid2_name, interpolation_crs_auth_name, interpolation_crs_code, operation_version, deprecated
    )
VALUES
...
INSERT INTO grid_alternatives(original_grid_name,                       proj_grid_name,                       old_proj_grid_name,                       proj_grid_format,                       proj_method,                       inverse_direction,                       package_name,                       url, direct_download, open_license, directory)
VALUES
('bq_nsgi_bongeo2004.gtx','bq_nsgi_bongeo2004.tif','bq_nsgi_bongeo2004.gtx','GTiff','geoid_like',0,NULL,'https://github.com/GeodetischeInfrastructuur/transformations/blob/main/grids/nl_nsgi/sbq_nsgi_bongeo2004.tif',1,1,NULL),
('nllat2018.gtx','','nllat2018 .gtx','GTX','geoid_like',0,NULL,'https://github.com/GeodetischeInfrastructuur/transformations/blob/main/grids/nl_nsgi/nllat2018.gtx',1,1,NULL);
