...
VALUES
    ...
    (
        'NSGI',
        'Saba_Local_GEOGRAPHIC_3D_to_Saba_Height',
    ...
    (
        'NSGI',
        'St_Eustatius_Local_GEOGRAPHIC_3D_to_St_Eustatius_Height',
        ...
        'Geographic3D to GravityRelatedHeight (gtx)',
        'NSGI',
        'St_Eustatius_Local_GEOGRAPHIC_3D',
        'NSGI',
        'St_Eustatius_Height',
        0.1,
        'EPSG',
...
VALUES
    ...
    (
        'NSGI',
        'Saba_Local_GEOGRAPHIC_3D_to_Saba_Height_USAGE',
        'grid_transformation',
        'NSGI',
        'Saba_Local_GEOGRAPHIC_3D_to_Saba_Height',
        'EPSG',
        ...
        'NSGI',
        'St_Eustatius_Local_GEOGRAPHIC_3D_to_St_Eustatius_Height_USAGE',
        'grid_transformation',
        'NSGI',
        'St_Eustatius_Local_GEOGRAPHIC_3D_to_St_Eustatius_Height',
        'EPSG',
