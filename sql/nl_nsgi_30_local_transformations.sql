...
VALUES
    ...
    (
        'NSGI',
        'Saba_DPnet_GEOGRAPHIC_3D_to_Saba_Height',
    ...
    (
        'NSGI',
        'St_Eustatius_DPnet_GEOGRAPHIC_3D_to_St_Eustatius_Height',
...
VALUES
    ...
    (
        'NSGI',
        'Saba_DPnet_GEOGRAPHIC_3D_to_Saba_Height_USAGE',
        'grid_transformation',
        'NSGI',
        'Saba_DPnet_GEOGRAPHIC_3D_to_Saba_Height',
        'EPSG',
        ...
        'NSGI',
        'St_Eustatius_DPnet_GEOGRAPHIC_3D_to_St_Eustatius_Height_USAGE',
        'grid_transformation',
        'NSGI',
        'St_Eustatius_DPnet_GEOGRAPHIC_3D_to_St_Eustatius_Height',
        'EPSG',
